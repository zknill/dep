...
// IsSpecificSemVer is a helper that returns whether the given constraint is a range constraint.
// branches, tags, revisions, and explicit versions should return true.
func IsSpecificSemVer(c Constraint) bool {
